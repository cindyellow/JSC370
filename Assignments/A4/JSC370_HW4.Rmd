...
# sim_pi(1000)
```
First, we try using `lapply` to simulate PI 4,000 times, each with 10,000 points. The resulting value and runtime are: 
```{r}
set.seed(1231)
time1 <- system.time({
...
By using parallel computing, we have reduced runtime by `r round(100*(time1['elapsed'] - time2['elapsed'])/time1['elapsed'],3)`%. 
